...
const ANTI_FOUC = `(function(){
  try{
    ...
    var d={'--sf-bg-deep':'#050505','--sf-bg':'#0a0a0a','--sf-surface':'#141414','--sf-surface2':'#111111','--sf-surface3':'#0d0d0d','--sf-input':'#1c1c1c','--sf-pill':'#1e1e1e','--sf-border':'#1a1a1a','--sf-border2':'#252525','--sf-text1':'#ffffff','--sf-text2':'#cccccc','--sf-text3':'#aaaaaa','--sf-text4':'#888888','--sf-text5':'#777777','--sf-text6':'#666666','--sf-text7':'#555555','--sf-text8':'#3a3a3a','--sf-shadow':'rgba(0,0,0,0.5)','--sf-overlay':'rgba(0,0,0,0.75)'};
